...
import { addLikedItem, removeLikedItem } from '../slices/likegood';
...
interface GobackIconItemProps3 {
  item: Item;
  navigation: any;
}

const GobackIconItem3: React.FC<GobackIconItemProps3> = ({ item, navigation }) => {
  const dispatch = useDispatch();
  const likeItems = useSelector((state: any) => state.likegood.items);
...
export default GobackIconItem3;
