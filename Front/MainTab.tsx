...
import Likes from './Front/src/pages/Likes';
import Write from './Front/src/pages/Write';
import Community from './Front/src/pages/Community';
import Home from './Front/src/pages/Home';
import Search from './Front/src/pages/Search';
