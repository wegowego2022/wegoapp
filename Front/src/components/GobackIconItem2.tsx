...
import { addLikedItem, removeLikedItem } from '../slices/likeplace';
...
interface GobackIconItemProps2 {
  item: Item;
  navigation: any;
}

const GobackIconItem2: React.FC<GobackIconItemProps2> = ({ item, navigation }) => {
  const dispatch = useDispatch();
  const likeItems = useSelector((state: any) => state.likeplace.items);
...
export default GobackIconItem2;
